...
class Select(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if new_role is not None:
            ...
            await interaction.response.send_message(f'You selected {selected_value} and have been assigned the role {new_role_name}.')
        else:
            await interaction.response.send_message(f'The role {new_role_name} does not exist.')
